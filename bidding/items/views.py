...
def validate(request):
    ...
    if bidderEmail==itemownerEmail:
        ...
        msg     = "Congratulations your item value has reached to "+"rs = "+value+ ".For further updates you will be notified .Thank You for using our app."
        to      = mail  
        res     = send_mail(subject, msg, "sjshub755@gmail.com", [to])
